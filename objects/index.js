...
console.log(mazda2.name, mazda2.drive(), mazda.stop());

const harley2 = new VehicleClass.Motorcycle('Harley');
console.log(harley2.name, harley2.wheelie(), harley.stop());

// Implement a car and motorcycle using a Factory
const mazda3 = new VehicleFactory.Car('Mazda 3');
console.log(mazda3.name, mazda3.drive(), mazda.stop());

const harley3 = new VehicleFactory.Motorcycle('Harley');
console.log(harley3.name, harley3.wheelie(), harley.stop());
